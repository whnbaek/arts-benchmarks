...
/**
 * DESC: Create a null-GUID EDT that has depv containing a once event and a db. (creation becomes synchronous)
 */
...
ocrGuid_t mainEdt(u32 paramc, u64* paramv, u32 depc, ocrEdtDep_t depv[]) {
    ...
    ocrEdtCreate(NULL, terminateEdtTemplateGuid, 0, NULL, 2, ndepv, EDT_PROP_NONE, &edtHint, NULL);
