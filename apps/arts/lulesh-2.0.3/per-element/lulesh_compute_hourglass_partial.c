/******************************************************************************
 * LULESH Per-Element ARTS Version - Compute Hourglass Partial EDT
 ******************************************************************************/
#include "lulesh.h"
...
void computeHourglassPartialEdt(uint32_t paramc, uint64_t *paramv, uint32_t depc, artsEdtDep_t depv[]) {
    ...
    // Get previous iteration element data
    ...
    // Get node positions and velocities from previous iteration
